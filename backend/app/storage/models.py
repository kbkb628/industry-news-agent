...
class EvalResult(Base):
    ...
    candidate_recall_proxy: Mapped[float] = mapped_column(Float, nullable=False, default=0.0)
    false_positive_proxy_count: Mapped[int] = mapped_column(Integer, nullable=False, default=0)
    candidate_task_failure_rate: Mapped[float] = mapped_column(Float, nullable=False, default=0.0)
    avg_event_latency_ms: Mapped[int] = mapped_column(Integer, nullable=False, default=0)
    runtime_cost_proxy: Mapped[dict[str, object]] = mapped_column(JSON, nullable=False, default=dict)
